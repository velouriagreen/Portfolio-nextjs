...
const MemorialFooter = () => {
	...
	return (
		...
		<footer id="memorial-footer" className={styles.footer}>
			<p>If you want to submit a photo or a comment, please send an email to <a className={styles.footerLink}href="mailto: art4dahlak@gmail.com">art4dahlak@gmail.com</a>
			</p>
