			...
			<div className={styles.article}>
				<div>
					...
					<div>
						...
						<p className={styles.articleParagraph}>
							After receiving an active deportation order, I was able to update the status of my case to a “Withholding of Removal” because I managed to prove how bad things would be for me if I returned. It’s a win, but even that win is a prison. After my release and a few years of not-fighting-the-system, I went full fuck-it mode and returned to a life of drugs, guns, and “financial” crimes. Credit cards, bank fraud and the like. It brought me joy learning of ways where I could live my life at the expense of imaginary “money” and banks, and it was fun while it lasted. I was sentenced to five years in prison and I spent three of those years in an Angola extension camp. There I worked my way up to a “trusty”, which granted me the privilege to work directly for the warden of a prison that was in a hybrid-like state and run by a private prison group.
						</p>
						...
						<p className={styles.articleParagraph}>
							I was able to share my knowledge and understanding of history and experience with a solid desire to move us forward while also learning ways to fight a most-oppressive system behind bars. We led hunger strikes and work strikes though I wouldn’t say they were a success. We crumbled under their full weight and influence. I take responsibility for the failures of our leadership that couldn’t sustain the momentum. We failed at conveying and convincing others about the power of solidarity because we felt that our ability to teach and mobilize would be sufficient. It wasn’t. We failed at solidifying resolve to hang strong through time and withstand the pushback. I took it personally every time we didn’t reach our objective and yet I hesitate to say I was part of the leadership then with so many amazing men there, men who constantly reminded us of what we each brought to the table whenever we doubted ourselves. I was taught that we all needed to play our parts no matter how many parts we had to play. I learned a lot from my brothers then that I still find strength from. Today I can proudly say that I learned to organize in prison, even though I still struggle at calling myself an organizer. Organizing out here is a different animal and I’m still learning the ways from others again. 
						</p>
