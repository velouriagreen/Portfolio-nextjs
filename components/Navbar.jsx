...
const Navbar = () => {
  ...
  useEffect(() => {
    if (
      ...
      router.asPath === '/watchparty' ||
      router.asPath === '/mykitchen' ||
  ...
  return (
    ...
    style={{ backgroundColor: `${navBg}` }}
      id="navbar"
      // className={`fixed w-full h-20 shadow-xl z-[100] ${nav ? "bg-black/70" : ""}`}
      className={
        shadow
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Link href="/">
          <Image src="/dklogo1.png" alt="/" width="125" height="50" />
        </Link>
        <div>
          ...
          <div>
            ...
            <div className="border-b border-gray-300 my-4">
              <p className="w-[85%] md:[90%] py-4">
                Let me get creative and build something
              </p>
            </div>
          </div>
